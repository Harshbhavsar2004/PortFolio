  ...
  return (
    <FooterContainer>
      <FooterWrapper>
        ...
        <Copyright>&copy; 2024 Harshal Bhavsar. All rights reserved.</Copyright>
      </FooterWrapper>
    </FooterContainer>
  );
};
...
function LeetCodeIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="leetcode" width="24" height="24">
      <path
        fill="#B3B1B0"
